...
* This script is only for respondents who earn $10k or less, HS or less education
...
* respondents at or below $10k and HS or less education
keep if Q2 <= 10000 & educ == 1
...
esttab avg_elast1 avg_elast2 avg_elast3 avg_elast4 avg_elast5 avg_elast6 ///
	using output/avg_elasticities_below10k_hs.tex, se ///
